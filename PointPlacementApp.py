...
from functions import ls_circle, apply_ct_window, detect_knee_bounding_boxes, find_outliers_with_bspline
...
class PointPlacementApp:
    def __init__(self, image_path):
        ...
        self.multichannel_image = self.process_image()  # Preprocess the image?
    ...
    def process_image(self):
        img = self.dicom_data.pixel_array.astype(float)
        if 'RescaleSlope' in self.dicom_data and 'RescaleIntercept' in self.dicom_data:
