...
from functions import ls_circle, \
    ...
    process_image, \
    count_white_pixels, \
    has_similar_sized_boxes, \
    process_dicom_files, \
    process_dicom_files2
...
class PointPlacementApp:
    def __init__(self, image_folder):
        ...
        self.dicom_data = process_dicom_files2(image_folder)
        print(f"Time Taken - Complete Read: {(time.process_time() - time_prev)}")
